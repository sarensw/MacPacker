...
//import Foundation
//
//public enum ArchiveHandlerType: String, Sendable {
//    case xad
//    case `7zip`
//    case swc
//}
//
//public class ArchiveHandlerHelper {
...
//}
//
//public protocol ArchiveHandlerProtocol {
//    func contents(of url: URL) throws -> [ArchiveItem]
//    func contents(of url: URL) async throws -> [ArchiveItem]
...
//    func extract(archiveUrl: URL, archiveItem: ArchiveItem, to url: URL)
//    func extract(archiveUrl: URL, to url: URL)
//    
...
//}
//
//public protocol ArchiveListing {
//    func contents(of url: URL) throws -> [ArchiveItem]
//    func contents(of url: URL) async throws -> [ArchiveItem]
//    func content(archiveUrl: URL, archivePath: String) throws -> [ArchiveItem]
//}
//
//public protocol ArchiveExtracting {
//    func extractToTemp(path: URL) -> URL?
//    func extractFileToTemp(path: URL, item: ArchiveItem) -> URL?
//    func extract(archiveUrl: URL, archiveItem: ArchiveItem, to url: URL)
//    func extract(archiveUrl: URL, to url: URL)
//}
//
//public protocol ArchiveEditing {
//    var isEditable: Bool { get }
//    func save(to: URL, items: [ArchiveItem]) throws
//}
