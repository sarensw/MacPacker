...
struct WelcomeWhatsNewView: View {
    var body: some View {
        VStack(alignment: .leading, spacing: 4) {
            ...
            WhatsNewPill(key: LocalizedStringResource("v0.15_issue_77", defaultValue: "Sorting enabled for all columns, sort order persisted and name is default", table: "LocalizableWhatsNew"), type: .feature)
