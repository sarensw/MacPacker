...
struct WelcomeWhatsNewView: View {
    var body: some View {
        VStack(alignment: .leading, spacing: 4) {
            ...
            WhatsNewPill(key: LocalizedStringResource("v0.12_fix_unicode_chars", defaultValue: "Chinese (Unicode) characters in archive contents not displayed correctly", table: "LocalizableWhatsNew"), type: .bug)
